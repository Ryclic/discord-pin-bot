...
module.exports = {
	...
	async execute(interaction) {
        ...
        /* 
            ...
            if there is a document then find and save given votecount
        */
        ...
        interaction.reply({ content: 'Success! The required number of people to pin has been set to ' + votecount + '.', ephemeral: true });
	},
};